...
import com.example.project.databinding.FragmentThreeBinding
import com.example.project.databinding.ItemRecyclerviewBinding
...
class MyDecoration(val context: Context): RecyclerView.ItemDecoration() {
    ...
    override fun getItemOffsets(
        ...
        if (index % 4 == 0) // left, top, right, bottom
...
class ThreeFragment : Fragment() {
    override fun onCreateView(
        ...
        datas.add("front-end")
        datas.add("html,css,js,django")
        datas.add("back-end")
        datas.add("c,python,django,db,kotlin")
